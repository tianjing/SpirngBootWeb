...
public class CronExpressionTask extends Task {
    protected TeamCronExpression teamCronExpression;
    ...
    public TeamCronExpression getTeamCronExpression() {
        return teamCronExpression;
    }

    public void setTeamCronExpression(TeamCronExpression pTeamCronExpression) {
        teamCronExpression = pTeamCronExpression;
    }

    public void setTeamCronExpression(String pCronExpression) throws ParseException {
        teamCronExpression = TeamCronExpression.create(pCronExpression);
    }
    ...
    protected void createDefaultTeamCronExpression() {
        try {
            teamCronExpression = TeamCronExpression.create("0 0/1 * * * ?");
        } catch (Exception e) {
